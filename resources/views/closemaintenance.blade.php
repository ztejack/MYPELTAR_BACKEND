        ...
        <main>
            ...
            <div class="maintenance">
                <ul class="tracing-option">
                    <li style="border-color: #198754;"><a href="/index" style="color: #198754;"><i
                                class="bi bi-clipboard2-check"></i>Maintained</a>
                    </li>
                    <li style="border-color: #ffc107; background-color: #ffc107;"><a href="#" style="color: #fff;"><i
                ...
                <div class="tracing-items">
                    <ul class="items">
                        <li><img src="img/item-1.png" alt="">
                            ...
                            <button style="font-weight: 900;">Closed</button>
                        </li>
